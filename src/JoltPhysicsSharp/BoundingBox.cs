...
//     {
//         return $"{nameof(BoundingBox)} {{ {nameof(Min)} = ({Min.X.ToString(format, formatProvider)}, {Min.Y.ToString(format, formatProvider)}, {Min.Z.ToString(format, formatProvider)}), {nameof(Max)} = ({Max.X.ToString(format, formatProvider)}, {Max.Y.ToString(format, formatProvider)}, {Max.Z.ToString(format, formatProvider)}) }}";
//     }
// }
