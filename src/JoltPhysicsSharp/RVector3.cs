...
//     public Vector3D(in Vector3 xyz)
//     {
//         X = xyz.X;
//         Y = xyz.Y;
//         Z = xyz.Z;
...
//     /// <param name="z">Initial value for the Z component of the vector.</param>
//     public Vector3D(in Vector2 xy, double z)
//     {
//         X = xy.X;
//         Y = xy.Y;
//         Z = z;
...
//
//     /// <summary>
//     /// The Y unit <see cref="Vector3D"/> (0, 0, 1).
//     /// </summary>
...
//
//     /// <summary>
//     /// Creates a new <see cref="Vector3D"/> value with the same value for all its components.
//     /// </summary>
//     /// <param name="x">The value to use for the components of the new <see cref="Vector3D"/> instance.</param>
//     public static implicit operator Vector3D(double x) => new(x, x, x);
//
//     /// <summary>
//     /// Casts a <see cref="Vector3"/> value to a <see cref="Vector3D"/> one.
//     /// </summary>
//     /// <param name="xyz">The input <see cref="Vector3"/> value to cast.</param>
//     public static implicit operator Vector3D(in Vector3 xyz) => new(xyz);
//
//     /// <summary>
//     /// Casts a <see cref="Vector3D"/> value to a <see cref="Vector3"/> one.
//     /// </summary>
//     /// <param name="xyz">The input <see cref="Vector3D"/> value to cast.</param>
//     public static explicit operator Vector3(in Vector3D xyz) => new((float)xyz.X, (float)xyz.Y, (float)xyz.Z);
//
...
//
//     /// <inheritdoc/>
//     public override readonly bool Equals([NotNullWhen(true)] object? obj) => obj is Vector3D value && Equals(value);
//
//     /// <summary>
...
//
//     /// <summary>
//     /// Compares two <see cref="Vector3D"/> objects for equality.
//     /// </summary>
//     /// <param name="left">The <see cref="Vector3D"/> on the left hand of the operand.</param>
//     /// <param name="right">The <see cref="Vector3D"/> on the right hand of the operand.</param>
//     /// <returns>
...
//
//     /// <summary>
//     /// Compares two <see cref="Vector3D"/> objects for inequality.
//     /// </summary>
//     /// <param name="left">The <see cref="Vector3D"/> on the left hand of the operand.</param>
//     /// <param name="right">The <see cref="Vector3D"/> on the right hand of the operand.</param>
//     /// <returns>
...
//         => $"{nameof(Vector3D)} {{ {nameof(X)} = {X.ToString(format, formatProvider)}, {nameof(Y)} = {Y.ToString(format, formatProvider)}, {nameof(Z)} = {Z.ToString(format, formatProvider)} }}";
//
//     internal static double GetElement(Vector3D vector, int index)
//     {
//         return index >= Count ? throw new ArgumentOutOfRangeException(nameof(index)) : GetElementUnsafe(ref vector, index);
//     }
//
//     [MethodImpl(MethodImplOptions.AggressiveInlining)]
//     private static double GetElementUnsafe(ref Vector3D vector, int index)
//     {
//         Debug.Assert(index is >= 0 and < Count);
//
//         return Unsafe.Add(ref Unsafe.As<Vector3D, double>(ref vector), index);
//     }
// }
