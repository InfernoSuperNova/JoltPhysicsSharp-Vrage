...
//     /// </summary>
//     public static int SizeInBytes => Unsafe.SizeOf<MatrixD>();
//
//     /// <summary>
...
//     public MatrixD(float m11, float m12, float m13, double m14,
...
//     /// Initializes a new instance of the <see cref="MatrixD"/> struct.
//     /// </summary>
//     /// <param name="matrix">The <see cref="Matrix"/> value to assign.</param>
...
//     {
//         readonly get { return new Vector3D(M14, M24, M34); }
...
//
//     /// <summary>
//     /// Casts a <see cref="Matrix"/> value to a <see cref="MatrixD"/> one.
//     /// </summary>
//     /// <param name="xyz">The input <see cref="Matrix"/> value to cast.</param>
//     public static implicit operator MatrixD(Matrix matrix) => new(matrix);
//
//     /// <summary>
//     /// Casts a <see cref="MatrixD"/> value to a <see cref="Matrix"/> one.
//     /// </summary>
//     /// <param name="xyz">The input <see cref="MatrixD"/> value to cast.</param>
//     public static explicit operator Matrix(in MatrixD matrix)
//     {
...
//
//     /// <inheritdoc/>
//     public override readonly bool Equals([NotNullWhen(true)] object? obj) => obj is MatrixD value && Equals(value);
//
//     /// <summary>
...
//     public readonly bool Equals(MatrixD other)
//     {
...
//
//     /// <summary>
//     /// Compares two <see cref="MatrixD"/> objects for equality.
//     /// </summary>
//     /// <param name="left">The <see cref="MatrixD"/> on the left hand of the operand.</param>
//     /// <param name="right">The <see cref="MatrixD"/> on the right hand of the operand.</param>
//     /// <returns>
//     /// True if the current left is equal to the <paramref name="right"/> parameter; otherwise, false.
//     /// </returns>
//     [MethodImpl(MethodImplOptions.AggressiveInlining)]
//     public static bool operator ==(MatrixD left, MatrixD right) => left.Equals(right);
//
//     /// <summary>
//     /// Compares two <see cref="MatrixD"/> objects for inequality.
//     /// </summary>
//     /// <param name="left">The <see cref="MatrixD"/> on the left hand of the operand.</param>
//     /// <param name="right">The <see cref="MatrixD"/> on the right hand of the operand.</param>
//     /// <returns>
